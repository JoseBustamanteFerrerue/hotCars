...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-04-2023 a las 18:08:40
...
(77, 123, 2016, 80000, 'Buen estado', 9500, 'Diesel', 'Manual', 'B', 'Berlina', 5, 'VF1BZRJ0F28428460', '1812 DTP', 'Navegador GPS', ''),
(78, 124, 2018, 30000, 'Perfecto estado', 22000, 'Gasolina', 'Automático', 'C', 'Berlina', 5, 'WBA2J310X0J367162', '5432 JKM', 'Asientos deportivos', ''),
(79, 125, 2017, 60000, 'Buen estado', 12500, 'Diesel', 'Manual', 'B', 'Berlina', 5, 'WBA1F31090VX51276', '1890 FKH', 'Techo solar', ''),
(80, 126, 2019, 20000, 'Perfecto estado', 25000, 'Gasolina', 'Automático', 'C', 'SUV', 5, 'SALVA2AN4EH900562', '2564 JMF', 'Sistema de sonido BOSE', ''),
(81, 127, 2016, 80000, 'Buen estado', 9500, 'Diesel', 'Manual', 'B', 'Familiar', 5, 'VF1GJEJ0A53305194', '2995 FHT', 'Control de crucero', ''),
(82, 128, 2018, 45000, 'Perfecto estado', 21000, 'Gasolina', 'Automático', 'C', 'Berlina', 5, 'WBA2G51040V259997', '8745 KJR', 'Asientos eléctricos', ''),
(83, 129, 2017, 55000, 'Buen estado', 13000, 'Diesel', 'Manual', 'B', 'SUV', 5, 'WDC1569121J323219', '4219 HLP', 'Techo panorámico', ''),
(84, 130, 2018, 35000, 'Perfecto estado', 22000, 'Gasolina', 'Automático', 'C', 'Coupe', 4, 'WDD2053751F585090', '3658 HDM', 'Faros LED', ''),
(85, 131, 2016, 50000, 'Buen estado', 15000, 'Diesel', 'Manual', 'Etiqueta B', 'Compacto', 5, '1HGBH41JXMN109186', '3412-BCF', 'Asientos de cuero, techo solar', ''),
...
(87, 133, 2013, 70000, 'Buen estado', 12500, 'Diesel', 'Manual', 'Etiqueta C', 'Familiar', 5, '1HGCM56768A149843', '4625-JVN', 'Faros de xenón, climatizador bizona', ''),
...
(89, 135, 2018, 40000, 'Buen estado', 17000, 'Diesel', 'Automático', 'Etiqueta C', 'SUV', 5, '3D7JB1EP9BG162834', '2712-HDF', 'Navegador, asientos calefactables', ''),
...
(91, 137, 2015, 60000, 'Buen estado', 12000, 'Diesel', 'Manual', 'Etiqueta C', 'Berlina', 5, '1GCHK29U14E104467', '9834-JNR', 'Climatizador bizona, sensor de lluvia', ''),
...
(97, 144, 2018, 50000, 'Buen estado', 13500, 'Diesel', 'Manual', 'C', 'Berlina', 5, '1GNKVGKDXEJ305210', '8454 YZR', 'Navegador, Bluetooth, Sensores de aparcamiento', ''),
...
(99, 146, 2016, 80000, 'Buen estado', 10900, 'Diesel', 'Manual', 'C', 'Compacto', 5, '1GNKVGKDXFJ179347', '1169 JFN', 'Sensor de aparcamiento, Cámara trasera, Bluetooth', ''),
...
(103, 151, 2018, 35000, 'buen estado', 17500, 'diesel', 'manual', 'C', 'familiar', 5, 'JTHBW1GG202045505', '4444 BCB', 'Asientos de cuero', ''),
(104, 152, 2020, 20000, 'perfecto estado', 24500, 'gasolina', 'automatica', 'C', 'compacto', 5, 'WVWZZZ1KZAP139745', '3333 DDE', 'Navegador GPS', ''),
(105, 153, 2016, 80000, 'buen estado', 11500, 'diesel', 'manual', 'B', 'monovolumen', 7, 'WVWZZZ1KZAP139741', '5555 EEF', 'Asientos calefactables', ''),
(106, 154, 2017, 50000, 'buen estado', 15500, 'gasolina', 'manual', 'B', 'compacto', 5, 'WVWZZZ1KZAP139756', '6666 FFG', 'Camara trasera', ''),
(107, 155, 2019, 35000, 'buen estado', 18500, 'diesel', 'manual', 'C', 'familiar', 5, 'WAUZBZ1KZAP139756', '7777 GGH', 'Climatizador', ''),
(108, 156, 2018, 45000, 'buen estado', 15900, 'diesel', 'manual', 'C', 'familiar', 5, 'WAUZZZ3XZAP139756', '8888 HHI', 'Asientos deportivos', ''),
(109, 157, 2016, 85000, 'buen estado', 11500, 'diesel', 'manual', 'B', 'monovolumen', 7, 'VF7XZV1KZAP139726', '9999 III', 'Techo panoramico', ''),
(110, 158, 2017, 65000, 'buen estado', 15500, 'gasolina', 'manual', 'B', 'compacto', 5, 'VSKLÑZZZ1KZAP1397', '1010 JJK', 'Bluetooth', ''),
(111, 159, 2019, 38000, 'buen estado', 18500, 'diesel', 'manual', 'C', 'familiar', 5, 'WAUZZZ1KZAP135421', '1111 KKL', 'Llantas de aleacion', ''),
(112, 160, 2018, 55000, 'buen estado', 15900, 'diesel', 'manual', 'C', 'familiar', 5, 'WAUZ7Z1XZCP139756', '1212 LLM', 'Faros de xenon', ''),
(113, 161, 2016, 90000, 'buen estado', 11500, 'diesel', 'manual', 'B', 'monovolumen', 7, 'VF7ZLZ1KZAP1297X6', '1313 MMM', 'Sensores de aparcamiento', ''),
...
(116, 165, 2016, 60000, 'Buen estado', 14500, 'Diesel', 'Manual', 'B', 'Berlina', 5, '1HGCM56347A123457', '5408 WBB', 'Cámara de aparcamiento', ''),
(117, 166, 2017, 45000, 'Buen estado', 17000, 'Gasolina', 'Manual', 'C', 'Compacto', 5, '1HGCM56347A123458', '7812 KLB', 'Asientos calefactables', ''),
(118, 167, 2015, 80000, 'Buen estado', 13500, 'Diesel', 'Manual', 'B', 'SUV', 5, '1HGCM56347A123459', '3169 SMM', 'Climatizador bizona', ''),
(119, 168, 2018, 35000, 'Perfecto estado', 23000, 'Gasolina', 'Manual', 'C', 'Berlina', 5, '1HGCM56347A123460', '8923 PTH', 'Tapicería de piel', ''),
(120, 169, 2016, 70000, 'Buen estado', 13500, 'Diesel', 'Manual', 'B', 'Compacto', 5, '1HGCM56347A123461', '3045 JPS', 'Volante multifunción', ''),
(121, 170, 2015, 90000, 'Buen estado', 12500, 'Gasolina', 'Manual', 'C', 'Berlina', 5, '1HGCM56347A123462', '1382 YMR', 'Bluetooth', ''),
(122, 171, 2016, 75000, 'Buen estado', 14500, 'Diesel', 'Manual', 'B', 'SUV', 5, '1HGCM56347A123463', '1462 KLS', 'Llantas de aleación', ''),
(123, 172, 2014, 95000, 'Buen estado', 9900, 'Gasolina', 'Manual', 'C', 'Compacto', 5, '1HGCM56347A123464', '6810 TGL', 'Pintura metalizada', ''),
(124, 173, 2017, 55000, 'Buen estado', 15500, 'Diesel', 'Manual', 'B', 'Berlina', 5, '1HGCM56347A123465', '9087 BVT', 'Sistema de sonido de alta fidelidad', ''),
...
(127, 177, 2015, 59000, 'Buen estado', 18900, 'Diesel', 'Manual', 'B', 'Familiar', 5, 'YS3E4BJ44A0223456', '2222-CCC', 'Climatizador, Asientos calefactables, Llantas de aleación, Control de ', ''),
...
(132, 182, 2017, 58000, 'Buen estado', 21100, 'Diesel', 'Manual', 'B', 'Familiar', 5, 'YS3E4BJ44A0723456', '7777-HHH', 'Climatizador, Bluetooth, Llantas de aleación, Sensor de lluvia', ''),
(133, 183, 2015, 72000, 'Buen estado', 16900, 'Diesel', 'Manual', 'B', 'Monovolumen', 7, 'YS3E4BJ44A0823456', '8888-III', 'Asientos calefactables, Sensor de aparcamiento, Control de tracción, C', ''),
...
(135, 185, 2016, 93000, 'buen estado', 10500, 'Diesel', 'Manual', 'B', 'Compacto', 5, 'JMZKE2D84H0356154', '7349 GZZ', 'Cierre centralizado, Elevalunas eléctrico', ''),
...
(137, 187, 2014, 86000, 'buen estado', 8990, 'Diesel', 'Manual', 'B', 'SUV', 5, 'WVWZZZ1KZAM693281', '3818 HBL', 'Control de crucero, Bluetooth', ''),
